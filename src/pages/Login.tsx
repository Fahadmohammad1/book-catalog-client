...
export default function Login() {
  ...
  return (
    <section className="h-screen flex items-center justify-center">
      <div className="bg-purple-900 absolute left-0 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 bottom-0 leading-5 h-full w-full overflow-hidden top-0"></div>
      <div className=" sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
        <div className="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
          <div className="self-start hidden lg:flex flex-col  text-gray-300">
            ...
            <Link to="/">
              <button className="btn btn-sm mt-4 w-full bg-white text-black">
                <AiOutlineSwapLeft /> Back To Home
              </button>{" "}
            </Link>
          </div>
        </div>
